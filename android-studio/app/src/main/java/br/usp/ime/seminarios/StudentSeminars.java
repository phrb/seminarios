...
public class StudentSeminars extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    private List<Seminar> attendedSeminars;
    private List<Seminar> seminarList;
    private SeminarRecyclerViewAdapter all_adapter;
    private SeminarRecyclerViewAdapter attended_adapter;
    private ProgressBar progress_bar;
    private RecyclerView seminars;

    private String user_name, user_pwd, user_token;

    protected void updateAttended(final JSONObject seminar, final Seminar new_seminar) {
        ...
        try {
            stringRequest = new StringRequest(Request.Method.POST, url,
                            ...
                            if (response.contains("\"success\":true")) {
                                ...
                                try {
                                    ...
                                    for(int i = 0; i < data.length(); i++){
                                        ...
                                        if (attendee.getString("student_nusp").equalsIgnoreCase(user_name)) {;
                                            new_seminar.setAttended(true);
                                            attendedSeminars.add(new_seminar);
                                        }
                                    }
                ...
                String body = "seminar_id=" + seminar.getString("id");
                @Override
    ...
    protected void updatedAvailable(JSONObject seminar) throws JSONException {
        final Seminar new_seminar = new Seminar();
        ...
        updateAttended(seminar, new_seminar);

        if (!new_seminar.isAttended()) {
    ...
    protected void updateSeminarLists(String response) throws JSONException {
        ...
        for (int i = 0; i < data.length(); i++) {
            final JSONObject new_seminar = data.getJSONObject(i);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_seminars);
        ...
        attendedSeminars = new ArrayList<>();
        ...
        RequestQueue.RequestFinishedListener finishedListener = new RequestQueue.RequestFinishedListener() {
            ...
            public void onRequestFinished(Request request) {
                all_adapter = new SeminarRecyclerViewAdapter(StudentSeminars.this, seminarList);
                attended_adapter = new SeminarRecyclerViewAdapter(StudentSeminars.this, attendedSeminars);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.student_seminars, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_all) {
            ...
            seminars.setAdapter(attended_adapter);
